...
import com.harrySpringBoot.expensetrackerapi.exceptions.ItemAlreadyExistsExeception;
...
public class UserServiceImpl implements UserService {
    ...
    public User createUser(UserModel user) {
        ...
        if (userRepository.existsByEmail(user.getEmail())) {
            throw new ItemAlreadyExistsExeception("User is already register with email : " + user.getEmail());
        }
